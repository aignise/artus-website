      ...
      <div className="flex justify-between items-center py-4 px-6">
        ...
        <div className="hidden lg:block">
          <Link
            ...
            target="_blank"
            className="bg-[#046EC5] text-sm xl1:text-base 2xl:text-lg border flex items-center border-[#046EC5] text-white rounded-full font-semibold min-h-11 leading-none px-5"
          >
