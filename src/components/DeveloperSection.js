      ...
      <div className="pt-32 pb-16 w-[80%] mx-auto">
        ...
        <div className="flex items-center gap-3 justify-center pb-16 pt-40">
          ...
          <Link
            ...
            target="_blank"
            className="bg-gradient-to-r from-[#6EBAF8] to-[#046EC5] hover:to-[#6EBAF8] text-xs xl1::text-base 2xl:text-lg flex items-center min-h-11 leading-none text-white rounded-full font-semibold py-2.5 px-8"
          >
