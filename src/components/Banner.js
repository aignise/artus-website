...
const Banner = () => {
  return (
    <div className="relative">
      ...
      /> */}
      <div className="relative z-10 mt-10 sm:mt-20 md:mx-14 lg:mx-12 sm:mx-10 mx-4">
        <h1
          className="bg-gradient-to-r from-[#1967FE] to-[#07C76D] bg-clip-text text-transparent text-center font-inter font-semibold text-[56px] sm:text-[62px] md:text-[68px] lg:text-[74px]  xlu:text-[80px] leading-[70px] sm:leading-[83.992px] tracking-[-4.456px] 
shadow-[2.461px_4.923px_9.846px_rgba(0,0,0,0.15)]"
        ...
        <div className="flex gap-3 px-5 sm:px-0 justify-center mb-4 sm:mb-0 mt-10">
          <Link
